...
const projects = [
  ...
  },
  {
    title: "AeroStream AI",
    tag: "Aviation CV",
    description: "Real-time wildlife detection system for airports using YOLOv11 and Kalman Filters. Prevents bird strikes through predictive trajectory analysis.",
    techStack: ["YOLOv11", "Kalman Filters", "Computer Vision", "Real-time"],
    github: "https://github.com/rafael-ibayev/aerostream-ai",
    math: "x_k = Fx_{k-1} + Bu_k + w_k",
    ...
    >
      ...
      <div className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" 
           style={{ 
             ...
             background: "linear-gradient(135deg, rgba(16, 185, 129, 0.05) 0%, transparent 50%, rgba(16, 185, 129, 0.02) 100%)"
           }} 
      />
      ...
      <div className="relative p-8">
        ...
        <div className="flex items-start justify-between mb-6">
          <div>
            <motion.span
              className="font-mono-label text-[#10b981] mb-3 block"
            ...
            <h3 className="text-2xl md:text-3xl font-bold text-foreground group-hover:text-[#10b981] transition-all duration-300">
              {project.title}
            </h3>
          </div>
          <a
            ...
            className="relative z-10 p-3 rounded-full glass-card text-muted-foreground hover:text-[#10b981] hover:border-[#10b981]/40 hover:shadow-[0_0_15px_rgba(16,185,129,0.3)] transition-all duration-300"
        ...
        {project.math && (
          <div className="mb-6 p-3 rounded-lg bg-secondary/30 border border-border/50 font-mono text-sm text-[#10b981]">
            <span className="text-muted-foreground text-xs mr-2">ƒ(x):</span>
            {project.math}
          </div>
        )}
        ...
        <div className="flex flex-wrap gap-2">
          {project.techStack.map((tech, ti) => (
            <motion.span
              key={tech}
              className="px-3 py-1.5 rounded-full text-xs font-medium bg-secondary/50 text-secondary-foreground border border-border/50 hover:border-[#10b981]/40 hover:text-[#10b981] transition-all duration-300"
        ...
        <motion.a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 mt-8 text-sm font-medium text-[#10b981] hover:text-[#34d399] transition-colors group/link"
          whileHover={{ x: 5 }}
        >
  ...
  return (
    <section id="projects" className="py-24 px-6 relative">
      ...
      <div className="container max-w-7xl mx-auto relative">
        ...
        >
          <motion.span
            className="font-mono-label text-[#10b981] mb-4 block"
          ...
          <motion.div
            className="h-1 bg-gradient-to-r from-[#10b981] to-[#34d399] rounded-full mt-4"
            initial={{ width: 0 }}
